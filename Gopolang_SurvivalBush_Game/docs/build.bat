...
set JAVA_HOME="C:\Users\pants\Desktop\CSC\Softwares\jdk-17.0.2"
set PATH=%JAVA_HOME%\bin;%PATH%
REM Paths for JavaFX
set USE_JAVAFX=true
set JAVAFX_HOME=C:\Users\pants\Desktop\CSC\Softwares\javafx-sdk-17.0.2
...
set PRAC_LIB=.\lib\*
set PRAC_SRC=.\src\survivalbush\game

REM Compile project by compiling just Main. Main will reference required classes.
:COMPILE
echo ~~~ Compiling project ~~~
javac %JAVAFX_ARGS% -sourcepath %PRAC_SRC% -cp %PRAC_BIN%;%PRAC_LIB% -d %PRAC_BIN% %PRAC_SRC%\Game.java
IF /I "%ERRORLEVEL%" NEQ "0" (
...
javadoc %JAVAFX_ARGS% -sourcepath %PRAC_SRC% -classpath %PRAC_BIN%;%PRAC_LIB% -use -version -author -d %PRAC_DOCS%\%PRAC_JDOC% survivalbush
IF /I "%ERRORLEVEL%" NEQ "0" (
...
java %JAVAFX_ARGS% -cp %PRAC_BIN%;%PRAC_LIB% survivalbush.game.Game
IF /I "%ERRORLEVEL%" NEQ "0" (
