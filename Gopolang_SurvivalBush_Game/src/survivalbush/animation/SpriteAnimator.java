package survivalbush.animation;
...
/**
 * Class responsible for the transition of sprites.
...
public class SpriteAnimator extends Transition{
    ...
    /**
     * Updates the transition/movement of a player
     * @param mover @see Mover from the controller class.
     * @param offsetYDown
     * @param offsetYLeft
     * @param offsetYRight
     * @param offsetYUp
    ...
    /**
     * Updates the view when the player view.
     * @param mover
     * @see Mover
     *
     */
