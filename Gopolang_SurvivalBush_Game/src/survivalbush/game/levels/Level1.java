package survivalbush.game.levels;
...
import survivalbush.animation.SpriteAnimator;
import survivalbush.game.PlayerProperties;
import survivalbush.object2D.Character2D;
import survivalbush.controller.Controller;
import survivalbush.controller.Mover;
import survivalbush.object2D.GameObject2D;
import survivalbush.object2D.Hotspot;
import survivalbush.state.IState;
import survivalbush.state.StateStack;

import java.util.ArrayList;

import static survivalbush.game.Game.root;
...
public class Level1 implements IState {
     ...
     *
     */
    public Level1(Scene scene, GraphicsContext graphicsContext) {
        this.scene = scene;
    ...
    public void init() {
        ...
        otherSprites = new Image(getClass().getResourceAsStream("../resources/images.png"));
